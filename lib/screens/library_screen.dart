...
class _LibraryScreenState extends State<LibraryScreen> with SingleTickerProviderStateMixin {
      ...
      itemBuilder: (ctx, i) {
        ...
        return ListTile(
          leading: CircleAvatar(
            backgroundColor: const Color(0xFF1DB954).withOpacity(0.3),
  ...
  Widget _buildFavorites() {
    if (_favorites.isEmpty) {
      return const Center(
        child: Text('Aucun favori', style: TextStyle(color: Color(0xFF9A9A9A))),
      );
    }
    return ListView.builder(
      padding: const EdgeInsets.only(bottom: 100),
              ...
              background: Stack(
                ...
                children: [
                  Image.network(
                    ...
                    fit: BoxFit.cover,
                    errorBuilder: (_, __, ___) => Container(color: const Color(0xFF0D2117)),
                  ),
                  const DecoratedBox(
