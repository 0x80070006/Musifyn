  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _searching
          ...
          : _results.isEmpty
              ? const Center(
                  child: Text('Recherchez de la musique', style: TextStyle(color: Color(0xFF9A9A9A))),
                )
              : ListView(
                    ...
                    if (artists.isNotEmpty) ...[
                      ...
                      ...artists.map((a) => ListTile(
                        leading: const CircleAvatar(
                          backgroundColor: Color(0xFF1A2A1F),
                          child: Icon(Icons.person, color: Color(0xFF1DB954)),
                        ),
                        title: Text(a.name, style: const TextStyle(color: Colors.white)),
                        subtitle: const Text('Artiste', style: TextStyle(color: Color(0xFF9A9A9A))),
                      )),
                    ],
