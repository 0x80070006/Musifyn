                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (widget.album.artistName != null)
                          Text(widget.album.artistName!, style: const TextStyle(color: Color(0xFF9A9A9A))),
                        if (widget.album.year != null)
                          Text('${widget.album.year}', style: const TextStyle(color: Color(0xFF9A9A9A), fontSize: 13)),
                      ],
                    ),
                  ),
                ],
